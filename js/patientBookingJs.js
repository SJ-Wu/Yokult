...
$(function () {
    ...
    function weekDate(date) {
        ...
        let next_2week_start = new Date(
            next_week_start.getTime() + sevenDayMillis
        );
        let next_2week_end = new Date(
            next_2week_start.getTime() + sixDayMillis
        );

        let next_3week_start = new Date(
            next_2week_start.getTime() + sevenDayMillis
        );
        let next_3week_end = new Date(
            next_3week_start.getTime() + sixDayMillis
        );
                ...
                $.each(data.schedule.list, function (i, listitem) {
                    ...
                    $.each(
                        ...
                        function (index, item) {
                            ...
                            if (
                                listitem.doctorScheduleDate.substring(8) == str
                            ) {
